...
Create a new script, function, workflow, or subworkflow with function `new_file()`, which is also accessible via a RStudio Addin. Simply follow the instructions in the dialog boxes.
